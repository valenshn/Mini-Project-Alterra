...
WebUI.setText(findTestObject('Object Repository/Page_frontend-web/field_password_register'), "siahaan")
WebUI.click(findTestObject('Object Repository/Page_frontend-web/button_Register'))
WebUI.click(findTestObject('Object Repository/Page_frontend-web/button_Register'))
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_frontend-web/valtext_fullname is required'), 0)
WebUI.closeBrowser()