...
WebUI.setText(findTestObject('Object Repository/Page_frontend-web/field_email_login'), 'valentina.siahaan@kawanlamacorp.com')

WebUI.click(findTestObject('Object Repository/Page_frontend-web/field_password_login'))

WebUI.setText(findTestObject('Object Repository/Page_frontend-web/field_password_login'), 'siahaan')
